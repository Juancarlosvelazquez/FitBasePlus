...
public class WalkData {
    ...
    public WalkData(int date, int averageHearRate, int averageStepRate, int totalCalories, double stepDistance, float totalAltitude, int totalDistance, int step, float totalDescent, long totalTime, float averagePace, double averageSpeed) {
        this.date = date;
